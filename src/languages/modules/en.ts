export default {
	exclusiveCouponsClaim: 'Exclusive coupons ({0})· Claim on register',
	...
	appUpdateFeature1: 'Add a feature to display version numbers',
	appUpdateFeature2: 'Fixed stuttering issues in certain scenarios',
	appUpdateFeature3: 'Improve overall loading speed',
	appUpdateLater: 'later',
	appUpdateConfirm: 'Upgrade Now',
	securityInfo: 'Security information',
	titleLearnAboutVault: 'Learn about safes',
	tipMinimumIncome: 'Minimum return, daily interest',
	tipEarningsCaculatedEveryMinites: 'After the balance is transferred in, profit will be calculated once every {0} minute',
	...
	tipPlsDoNotTransferInOutFrequently:
		'Please do not transfer in and out frequently. Earnings will be calculated from {0} minute after deposit. If the cumulative amount of an earned amount is less than 0.01, the amount will not be counted in "earnings".',
	security: 'Safe',
	...
	shareInvitationPoster: 'DOWNLOAD QR CODE',
	shareToOtherApps: 'Share to other apps to invite friend',
	urgeOrder: 'Urge Order',
	urgeOrderSuccess:
		'Your request has been submitted to the responsible specialist. We will process your issue as soon as possible. Please wait patiently. Thank you for your understanding and support',
	copyInvitationLink: 'Copy invitation link',
	titlePromotion: 'Agency',
	promotionGuestTitle: 'Agency promotion center',
	promotionGuestDesc: 'Log in to view your invitation code, subordinate data, and commission details',
	promotionGuestAction: 'Log in to view',
	promotionGuestBrowsePrefix: 'Prefer not to log in? You can view',
	promotionGuestBrowseJoin: 'and',
	rule: 'Rules',
	betRebateAmount: 'Total Comm',
	...
	firstBindNameLockTip:
		'This is your first payout account. The name will be locked once saved, and all future withdrawal methods must use the same name.',
	...
	descTotalAssets: '24-hour estimated revenue',
	...
	instructionDesc2:
		'The company will not be responsible for any losses incurred as a result of the transfer amount not matching the order you made.',
	...
	cancel: 'Cancel',
	noCoupon: 'No coupon',
	couponArrivalTitle: 'Exclusive Top-Up Coupons',
	couponArrivalSubtitle: 'We are giving you {0} recharge coupons',
	couponRechargeName: 'Top-Up Coupons',
	...
	couponThreshold: '{0} or more',
	couponValidDays: '{0} days',
	couponUpperLimit: 'Up to {0}',
	couponMaxReturns: 'Top-up rebate {0}%',
	couponClaimNow: 'Claim Now ({0} tickets)',
	myRechargeCoupon: 'My Top-Up Coupons',
	couponUnused: 'Unused',
	couponUsed: 'Used',
	couponExpired: 'Expired',
	couponGoUse: 'Use',
	redeemNoteTitle: 'Redemption Notes',
	redeemNote1: 'One code claims one gift. Cash is credited directly; coupons go to "My Top-Up Coupons".',
	redeemNote2: 'Coupons have a spending threshold and a validity period, please use them before they expire.',
	couponSource: 'Source: {0}',
	...
	getHintDesc1: 'Guess Number Green/Violet/Red to win',
	totalBet: 'Total',
	sameNum: '2 same',
	numbersMatch: '3 same',
	...
	code206: 'USDT wallet has been used on another account',
	...
	code329: 'The content of betting in the second perfect is incorrect',
	code330: 'The content of betting in the triple is incorrect',
	code331: 'Four all bets are incorrect',
	code332: 'Two full selection and first prize mantissa cannot use multiple selection',
	code333: 'Game closed',
	code334: 'Game issue number is incorrect',
	code335: 'Incorrect game odds',
	code336: 'The game betting content is inconsistent with the betting amount',
	code337: 'Only unsettled game sessions can be wagered',
	code338: 'Bets are formatted incorrectly',
	code339: 'Game odds not set',
	code340: 'Incorrect initial amount',
	code341: 'Incorrect betting multiple',
	code342: 'Betting details cannot be empty',
	...
	enterUSDTAmount: 'Please enter USDT amount',
	...
	winColor1: 'Red',
	winColor2: 'Green',
	winColor3: 'Red Violet',
	winColor4: 'Violet Green',
	winColor5: 'Violet',
	...
	rangeDesc2: `Can't be less than {0}`,
	rangeDesc3: `Can't be more than {0}`,
	...
	lotteryHintStr2: 'Green/Red/Violet to win',
	...
	wrongTel: 'Invalid phone number. Please enter a valid number.',
	...
	highestRebate: 'Permanent commission up to <span>{0}%</span>',
	...
	titleGot: 'Receive',
	dailyRateReturn: 'The daily interest rate is {0}%, and the income is calculated once every {1} minutes.',
	prompt: 'Notification',
	orderTotalAmount: 'Total order amount',
	integerRequired: 'Please enter an integer, from 1 to',
	rpdsucceed: 'Successfully modified',
	onConfirmMsg4: 'USDT address length must not exceed 36 characters',
	...
	c2cInstructions1:
		'After completing the UPI transaction, please enter 12 digits <span data-v-470caa86 class="red">Ref No./UTR</span> If not enter<span data-v-470caa86 class=" red">UTR</span>, company is not responsible for any losses incurred, be sure to fill them in!',
	c2cInstructions2: 'Use C2C for deposits, each deposit will get an additional 2% bonus;',
	c2cInstructions3:
		'After completing the UPI transaction, please fill in the Ref No./UTR If you do not enter the UTR, company is not responsible for any losses incurred, be sure to fill them in!',
	...
	c2cRechargeUpiSheet4: 'Continue to Purchase',
	orderAmount: 'Amount',
	...
	c2cTip15:
		'If you have already transferred to the UPI recipient, please do not cancel the order, to avoid causing loss to you.',
	...
	idlockTip1: 'You Have Entered Wrong Password More Than {0} Times',
	...
	systemresult:
		'If the system results are not the same as the lottery results, the system will recalculate as soon as the correct results are determined, the final results will be based on the results of the lottery.',
	lotterytime:
		'Every day, 1 northern province will be drawn for prizes, once a day, the system is collectively known as the northern lottery. Below are the specific drawing times and the Northern lottery provinces (according to Vietnam time zone GMT+7)',
	lotterytime1:
		'Prize drawing time: Every day, there will be 3 southern provinces to draw prizes (Saturday will draw prizes for 4 provinces), 2 central provinces will be drawn for prizes (Thursday and Saturday will draw prizes for 3 provinces). Below are the drawing times and specific provinces of the Central/Southern Lottery (according to Vietnam time zone GMT +7)',
	weeks: 'Week',
	...
	taiping: 'Thái Bình',
	oddsmiscalculated:
		'If odds are miscalculated due to typographical error or other random reasons, we reserve the right to correct the error and will use the new odds as the basis for settlement.',
	oddsbettingprincipal:
		'The odds are all inclusive of the bet amount. The bet amount multiplied by the odds is the winning amount (including principal).',
	oddsfluctuate:
		'Odds can fluctuate and change over time. The system will pay out bets according to the odds at the time of placing the bet, if the odds change after the bet is placed it will not affect the placed bets, only the new bets will use the new odds.',
	...
	bothnumberappear:
		'Both of these numbers appear in the last 2 numbers of 18 lottery prizes, these 2 numbers appear many times, the profit is only calculated x1',
	althoughthecombination: `Although it's a combination`,
	appearstwice: '2 children appear, but only 1 bonus is counted',
	tipvietnamlottery1:
		'If a bet with more than two numbers is selected, the system will automatically form groups of two numbers and the bet amount will be multiplied by the number of groups formed.',
	tipvietnamlottery2: 'The system will automatically form 3 groups 2 all pick',
	tipvietnamlottery3:
		'All 3 numbers appear in the last 2 numbers of 18 lottery prizes, if these 3 numbers appear many times, only x1 profit is counted.',
	tipvietnamlottery4:
		'If a bet with more than three numbers is selected, the system will automatically form groups of three numbers and the bet amount will be multiplied by the number of groups formed.',
	tipvietnamlottery5:
		'All these 4 numbers appear in the last 2 numbers of 18 lottery prizes, if these 4 numbers appear more than once, only x1 bonus will be counted.',
	tipvietnamlottery6: 'The system will automatically form 3 groups of 4 . skewers',
	tipvietnamlottery7:
		'If a bet with more than 4 numbers is selected, the system will automatically form groups of 4 numbers and the bet amount will be multiplied by the number of groups formed.',
	...
	code343: 'Betting content cannot be empty',
	...
	code160: 'Wash code is not enough',
	code161: 'Lottery wash code is not enough',
	code162: 'Electronic wash code is not enough',
	code163: 'Video wash code is not enough',
	code164: 'Sport wash code is not enough',
	code165: 'Chess wash code is not enough',
	code166: 'Please check the code washing amount setting',
	code167: 'No vip0 level configured',
	code8000: 'Bet',
	...
	ruleillustrate: 'Rule',
	ruleillustrate1:
		'When you win the Super Jackpot in the game, you can get additional platform bonuses, and the bonuses will be distributed to you according to the multiple of the winning prize',
	ruleillustrate2:
		'Warning: Please claim all bonuses before the event ends, after the event ends, you will lose the chance to get the bonus',
	ruleillustaate3:
	...
	instructions2:
		'We work with more than 10,000 video games, slot and casino providers, all of whom are certified as fair gambling, support fast deposits and withdrawals, and friendly service.',
	...
	code146: 'Reward has been claimed',
	code151: 'Email has been registered',
	code152: 'Emails are sent frequently',
	code153: 'Restricted from sending mail',
	code154: 'Mail sent successfully',
	...
	code250: 'Member cash withdrawal method is not bound',
	...
	googleTip6:
		'The Google Authenticator security code is valid for 30 seconds, please enter the verification code within the validity period',
	...
	rechargeBankDetailTip:
		'Please fill in the name and account consistent with the payment account, otherwise you will not be able to get the bill!',
	...
	xosoTxt2:
		'If the number you cast matches the last {1} digits of any group of numbers in the {0} positions of the lottery result, you will win. If there is more than 1 winning number, the winning amount will be doubled accordingly.',
	...
	xosoTxt4:
		'If the voting number is matched with the first two digits of the first two digits of any set of the award from the special prize to the sixth prize (23), it is the winning. The winning number is more than one, and the amount of winning will double.',
	xosoTxt5:
		'From the special award to the sixth prize, there is a number of 45 numbers in front, which is the winning. If there are n numbers of 4 in front of the Six -Prize from Special to Sixth Prize, the reward is multiplied by N.',
	...
	xosoTxt10:
		'Choose 1 number to form a set of 4 -digit number from thousands of digits, hundreds, ten digits and individual digits for betting.',
	xosoTxt11:
		'The results of the lottery results {0} have the last 4 digits of 4567, which is the winning. If the number of {0} group number has a number of 4 in 4567, the reward is multiplied by N.',
	xosoTxt12: 'Select the number of {0} group numbers for betting',
	xosoTxt13:
		'If the number you cast matches the last {2} digits of any {1} group numbers in the {0} positions of the drawing results, you will win the prize.',
	...
	xosoTxt18:
		'If the number of the voting number is matched with the number of the eighth prizes of the lottery, it is the winning prize',
	...
	xosoTxt25:
		'If the voting number matches any set of numbers in the seventh prize of the lottery results, it is the winning. The winning number is more than one, and the amount of winning will double.',
	xosoTxt26:
		'If the voting number matches the last 2 digits of the award and the eighth prize, it is the winning. The winning number is more than one, and the amount of winning will double.',
	xosoTxt27:
		'The seventh prize is 45, which is the winning. If there are n 45 numbers in the seventh prize number, the reward is multiplied by N.',
	xosoTxt28:
		'The last two of the special prize or eighth prize are 45, which is the winning. If the last two of the special prizes and eighth prizes are 45, the reward multiplied by 2. Essence',
	...
	xosoTxt41:
		'The sixth prize is 456, then you will win. If there are more than one winning number, the amount of winning will double.',
	xosoTxt42:
		'The seventh prize is 456, then you will win. If there are more than one winning number, the amount of winning will double.',
	...
	xosoTxt48:
		'If the voting number matches the last three digits of the award and the seventh prize, it is the winning. The winning number is more than one, and the amount of winning will double.',
	xosoTxt49: 'The last 3 of the first prize is 456, and it is the winning.',
	xosoTxt50:
		'The last 3 of the special prize or seventh prize is 456, which is the winning prize. If the last 3 of the special prizes and the seventh prize are 456, the reward multiplied by 2',
	xosoTxt51:
		'Choose 1 number to form a set of 4 digits from thousands of digits, hundreds, ten digits and individual digits for betting',
	...
	xosoTxt54:
		'If the voting number matches the last three digits of the award and the last 3 -class prize, it is the winning. The winning number is more than one, and the amount of winning will double.',
	xosoTxt55:
		'The last three of the special prize or the sixth prize are 456, which is the winning. If the last 3 of the special prize and the sixth prize are 456, the reward is multiplied by 2.',
	xosoTxt56:
		'If the voting number is not matched with all the last two digits in the position of the lottery results, it is the winning.',
	...
	xosoTxt60: 'Harmony',
	xosoTxt61:
		'The value refers to the two digits after the special prize of the special prize, the minimum of 0, the minimum is 0, and the maximum is 18.',
	...
	xosoTxt86:
		'Please enter the betting number, separate the English partition number between the group, and separate the English comma with English commas.',
	xosoTxt87: 'Thousand',
	xosoTxt88: 'hundreds',
	...
	code9404: 'Three codes included',
	code9405: 'Four codes included',
	code9410: 'The latter two combinations',
	code9411: 'Group two code',
	code9412: 'Group three codes',
	code9413: 'Group four codes',
	code9420: 'Two stars',
	code9421: 'Special Prize',
	code9422: 'Special first two',
	code9424: 'First two numbers for first prize',
	code9425: 'Seven prizes',
	code9426: 'Eight prizes',
	code9427: 'Ten/individual',
	code9430: 'Positioning bladder',
	code9431: 'tenth place',
	code9432: 'ones digit',
	code9440: '3 Star',
	code9442: '1st Awards',
	code9443: '6th Awards',
	...
	upiInstructions1:
		'After completing the UPI transaction, please fill in Ref NO./utr If you do not fill in UTR,the loss of customer , our company will not responsible. please be sure to fill it back！',
	...
	damanRule:
		'The {0} platform advocates fairness, justice, and openness. We mainly operate fair lottery, blockchain games, live casinos, and slot machine games.',
	...
	code8104: 'Bind mobile phone rewards',
	...
	activityTagHot: 'HOT',
	activityTagRecommend: 'Recommended',
	activityTagNew: 'NEW',
	giftExchangeViewRecord: 'View record',
	giftExchangeCodePlaceholder: 'Enter an 8-digit redemption code',
	giftExchangeCodeError: 'Invalid code, please re-enter',
	...
	c2cWTip4:
		'Please click Confirm after receiving the amount paid by the other party! Those who maliciously refuse to click [Confirm Payment] will be banned.',
	...
	firstSave1:
		'Exclusive for the first recharge of the account. There is only one chance. The more you recharge, the more rewards you will receive. The highest reward is {0};',
	...
	firstSave4:
		'The bonus (excluding the principal) given in this event requires {0} times the coding turnover (i.e. valid bets) before it can be withdrawn, and the coding does not limit the platform;',
	firstSave5:
	...
	firstSaveT: 'Deposit {0} for the first time and you will receive {1} bonus',
	...
	safetyTips1:
		'Please use your own PIX account to obtain the order and QR code for recharge. Do not use the QR code provided by others to pay.',
	...
	proRule1:
		'Number of Teams: How many downline deposits you have to date. <br/>Team Deposits: The total number of deposits made by your downline in one day. <br/>Team Deposit: Your downline deposits within one day.',
	...
	binguoRuleText1:
		'Bingo18 starts selling at 06:00 every Monday to Sunday and ends at 21:55 at the latest. The lottery frequency is 10 minutes per period. Tickets will be sold continuously during each lottery period.',
	binguoRuleText2:
		'Bingo18 has 2 tables for you to choose from. At the main table you can play high cards, ties, low cards or total cards. Select the whole table to participate in all gameplay!',
	...
	binguoRuleText13:
		'Bet on a number, and if one, two or three of the lottery results are the same as the betting number, you will win.',
	binguoRuleText14:
		'If you bet on a 2-digit identical number, and the lottery result is the same as the 2-digit identical number, you will win.',
	binguoRuleText15:
		'If you bet on a 3-digit identical number, and the result is the same as the 3-digit identical number, you will win.',
	...
	code801: 'Tournament events are not open yet',
	...
	Play4DTip2:
		'Enter 4 numbers to form 1 bet, and you can choose the betting categories of big 10,000, small 10,000, first prize, second prize, third prize, special prize and consolation prize for betting.',
	Play4DTip3:
		'Enter 4 numbers back and forth to form 2 bets. You can choose the betting categories of big 10,000, small 10,000, first prize, second prize, third prize, special prize and consolation prize for betting.',
	Play4DTip4:
		'If you place a bet of Da Wan and the number you cast matches any of the Da Wan<font class="red">23</font> numbers, you will win and you will receive the corresponding level of bonus. If the betting numbers appear repeatedly in multiple sets of lottery numbers, the bonus will be accumulated.',
	Play4DTip5:
		'Enter 3 numbers plus an "R" (R includes 0-9, 10 numbers in this position) to form 4 numbers for a total of 10 bets. Enter a maximum of 2 digits of "R". You can choose the bet category of Big Thousand or Small Thousand. , first prize, second prize, third prize, special prize and consolation prize for betting.',
	Play4DTip6:
		'If you bet over 10,000, and the 10 numbers you bet match any of the <font class="red">23</font> groups of lottery numbers, you will win and you will receive the corresponding level of bonus. If the betting numbers appear repeatedly in multiple sets of lottery numbers, the bonus will be accumulated.',
	Play4DTip7:
		'According to the 4-digit number form of the bet, a bet is formed (full protection 24-4 different numbers, full protection 12-2 pairs of the same numbers, full protection 6-2 pairs of the same numbers, full protection 4-3 same numbers) can be selected The betting categories are Big Thousand, Small Thousand, First Prize, Second Prize, Third Prize, Special Prize and Consolation Prize.',
	Play4DTip8:
		'If you bet over 10,000 and the numbers you cast match any of the <font class="red">23</font> groups of lottery numbers in any order, you will win and you will get the corresponding level of bonus. If the betting numbers appear repeatedly in multiple sets of lottery numbers, the bonus will be accumulated.',
	Play4DTip9:
		'According to the 4-digit bet form, including 24 (4 different numbers) is a 24 bet, a package of 12 (2 numbers are the same) is a 12 bet, a package of 6 (2 pairs of numbers are the same) is a 6 bet, and a package of 4 is a bet. (3 numbers are the same) is 4 bets, and you can choose the betting categories of big ten thousand, small ten thousand, first prize, second prize, third prize, special prize and consolation prize for betting.',
	...
	periodCardWeekTab: 'Weekly Card',
	periodCardMonthTab: 'Monthly Card',
	periodCardPick: 'Choose a tier · Buy now',
	periodCardInstant: 'Instant cashback',
	periodCardDaily: 'Daily',
	periodCardBuy: 'Buy now',
	periodCardOrigin: 'Original',
	periodCardNoTier: 'No tiers available in this category',
	periodCardBuyWeekTitle: 'Buy Weekly Card',
	periodCardBuyMonthTitle: 'Buy Monthly Card',
	periodCardConfirmInstant: 'You will get instant cashback',
	periodCardConfirmDaily: 'You get daily',
	periodCardTotalReward: 'Total reward',
	...
	periodCardStatRemain: 'Remaining',
	periodCardClaimNow: 'Claim now',
	periodCardNextIn: 'Next claim in',
	periodCardSwipeHint: 'Swipe to view all {n} days',
	periodCardExpired: 'Expired',
	periodCardBuyDone: 'Purchase successful!',
	periodCardDoneAmount: 'Claim your {amount} instant cashback on the card',
	periodCardDoneDaily: 'Daily rewards start tomorrow for {n} days — remember to come back and claim',
	periodCardKnow: 'Got it',
	periodCardTookRealtime: 'Instant cashback credited',
	periodCardTookDaily: 'Daily reward credited',
	periodCardSoldOutTitle: 'Sold out today',
	periodCardSoldOut: 'Sold out',
	periodCardGateTitle: 'Not eligible yet',
	periodCardGateDesc: 'A higher total deposit is required. You need {gap} more to join',
	periodCardBalanceDesc: 'This card requires {need} in cash balance',
	periodCardGoRecharge: 'Recharge now',
	periodCardWeekName: 'Weekly Card',
	periodCardMonthName: 'Monthly Card',
	...
	code8116: 'New members receive bonuses on their first deposit loss',
	withdrwsTip5:
	...
	withdrwsTip6: 'If your registered bank information is incorrect, please contact customer service.',
	...
	oldPromptTip: 'My dear friend, you are finally back',
	...
	newMenberPackage: 'First gift',
	newMenberTip: 'There are two types of new member gift package rewards',
	newMenberRule: 'Bonus for first deposit negative profit',
	newMenberRule2: 'Play games and get bonuses only for new members',
	conditionsRule: 'Conditions of participation',
	afterDayBonus: 'Get Compensation Bonus',
	todayBonus: 'Total <span class="number">{0}%</span> compensation from First Deposit Amount',
	...
	registrationExample:
		'New member registration<span class="number">{0}</span> days, accumulated deposits<span class="number">{1}+</span>, valid bets<span class="number">{2}+</span>, you can apply for <span class="number">{3}</span> bonus.',
	depositMoney: 'Total Recharge',
	turntableCount: 'Number of spins',
	winType: 'Reward type',
	turntableWin: 'prize',
	turntableTime: 'Spin time',
	turntableWinTip: 'Congratulations you have won',
	...
	introduceTitle3: 'The platform reserves the right of final outcome of this event;',
	...
	turntableSatisfy:
		'Members who meet the requirements for <span>{0}</span> are eligible to participate in the Wheel Spin event. Members must bind a bank card before joining. Stand a chance to win hundreds of millions in cash and many other exciting prizes. Get ready for daily surprises and amazing rewards!',
	...
	cumulativeDeposits: 'Total Deposit',
	turntableRule2:
		'Members must reach the total deposit amount and cumulative deposit amount to be eligible to participate in the Wheel Spin',
	...
	turntableRule5:
		'The Wheel Spin round starts every morning at <span>00:00</span>. After making your deposit, you need to wait 5 minutes before the draw wheel starts.',
	turntableExample: `If a member makes cumulative deposits reaching <span>{0}</span> on the same day, they will receive <span>{1}</span> lucky draw opportunities. The draw is valid for the same day and cannot be rolled over to the next day!`,
	...
	code905: 'Your draws have been used up',
	...
	code246: 'The maximum limit for receving red envelopes for today has been reached',
	...
	turntableTip: 'You can participate in the turntable after binding {0}',
	signed: 'Signed in',
	...
	arGift: 'Use AR PAY to deposit for additional rewards {0} bonus',
	loading: 'loading',
	...
	arbTip2:
		'AR wallet can use ARB for quick deposits and withdrawals! ARB is a digital cryptocurrency jointly issued by the government, referred to as ARB. It is safe, stable and fast.',
	...
	arb4: 'Go to Purchase',
	TeamPartner: 'Partner rewards',
	Recharged: 'Recharged',
	noRecharged: 'Not recharged',
	RechargStatus: 'Recharged status',
	invitationFrind: 'Invite friends to get max rewards',
	invitationCount: 'Invitation count',
	invitationEffective: 'Effective Invitation count',
	invitationTotalBonus: 'Invitation total bonus ',
	invitationLink: 'INVITATION LINK',
	partnerRule:
		'eg: <br/> Player A {0} <span style="color:var(--norm_red-color)">{1}</span> and turnover <span style="color:var(--norm_red-color)">{2}</span>, you can\'t get bonus',
	partnerRule2: 'the reward has no limitation, the more you invited the more rewards you will get it',
	partnerRule3: `If the conditions are met the rewards will be automatically credited to player's balance`,
	code8122: 'Partner rewards',
	arbRecharge: 'ARB recharge',
	arbWithdraw: 'Withdraw as ARB',
	bigLotteryTip1: 'Big Lottery',
	bigLotteryTip2: 'Total Jackpot of the month',
	bigLotteryTip3: `Today's Jackpot`,
	bigLotteryTip4: 'No of participants',
	bigLotteryTip5: 'My raffle ticket',
	bigLotteryTip6: 'My probability of winning',
	bigLotteryTip7: 'Friendly reminder: The more raffle tickets you have, the higher your chances of winning',
	bigLotteryTip8: 'My points',
	bigLotteryTip9: 'How to earn points',
	bigLotteryTip10: 'Exchange for raffle tickets',
	discountB: 'Discount',
	bigLotteryTip11: 'Please confirm whether to use or not',
	bigLotteryTip12: 'Exchange for <span>{0}</span>raffle ticket',
	bigLotteryTip13: `You don't have enough points to exchange`,
	bigLotteryTip14: 'Successfully exchanged {0} raffle tickets',
	bigLotteryTip15: 'The system on the next day {0} will select {1} lucky winners',
	bigLotteryTip16: `Share the entire jackpot of today's big lottery`,
	bigLotteryTip17: 'Please remember to check if you have won!',
	eventD: 'Event description',
	bigLotteryTip18: 'What is Super lottery ?',
	bigLotteryTip19: '【Super Lottery】is an offical large-scale bonus event',
	bigLotteryTip20:
		'The jackpot of the Big Lottery is determined on the daily betting amount of all users on the platform. For every <span>{0}</span> bet placed by users on this platform, the jackpot increases by {1}',
	bigLotteryTip21: 'How to participate',
	bigLotteryTip22:
		'Users who participate in 【Super Lottery】do not need to pay any amount . They only need to use points to exchange for lottery tickets in order to participate.',
	bigLotteryTip23: 'How to win',
	bigLotteryTip24: `【Super Lottery】everyday <span>{0}</span> will draw a lottery,each draw will select <span>{1}</span> users, will draw <span>{1}</span>users will share the day's jackpot money`,
	bigLotteryTip25: 'The more lottery tickets you exchange, the higher your chances of winning',
	bigLotteryTip26: 'How to claim bonus',
	bigLotteryTip27: `The bonus will be automatically credited to the member's balance, and there are no wagering requirements for the winnings from the Big Lottery. The winnings can be withdrawn directly.`,
	bigLotteryTip28:
		'【Super Lottery】is an additional activity given to members by the platform.Members do not need to pay any additional costs.It is a large-scale reward activity brought to members, so that the platform has the final right of interpretation.',
	bigLotteryTip29:
		'Once you confirm participation in the lottery, you will need to wait for the draw results. Your points cannot be refunded',
	bigLotteryTip30: '【Super Lottery】is a periodic activity, and it may close at any time',
	bigLotteryTip31: 'Yesterday’s winning list',
	bigLotteryTip32: 'View historical winners list',
	bigLotteryTip33: 'Winning players',
	raffleTicket: 'Raffle tickets',
	bigLotteryTip34: `Successfully shared yesterday's 【Super Lottery】jackpot`,
	bigLotteryTip35: 'The bonus has been automatically deposited into your wallet balance.',
	bigLotteryTip36: '1.Earn points by inviting others',
	bigLotteryTip37: 'Invite friends to register and top up any amount to earn<span class="red">{0}</span> points',
	bigLotteryTip38: 'Successfully invited',
	bigLotteryTip39: '2. Rewards points',
	bigLotteryTip40:
		'The platform rewards players with different ratios of points based on their daily bets. The more they bet, the higher the ratio of rewards',
	bigLotteryTip41: '3.Recharge bonus points',
	bigLotteryTip42: 'The platform gives players different points based on their daily recharge amount',
	deposit: 'Deposit',
	giveAway: 'Give away',
	bigLotteryTip43: 'Receive single deposit amount{0}',
	bigLotteryTip44: 'Total deposited amount {0}',
	RechargeT: 'Recharge time',
	notRecharged: 'Not recharged',
	bigLotteryTip45: 'Only supports querying records for 30 days',
	bigLotteryTip46: 'Participate in the daily event to share the million-dollar jackpot',
	bigLotteryTip47: 'You can participate by exchanging points for lottery tickets',
	bigLotteryTip48: 'Historical jackpot',
	code193: 'CPF and PIX account contents are inconsistent',
	pixTip1: 'The contents of CPF and PIX accounts are inconsistent, please confirm and submit again!',
	arb3ios: 'Receive an extra %d%@ bonus when recharging with ARB.',
	withdrawAr3:
		'After approval, your balance will be withdrawn to <span>AR Wallet</span><br/> Please click <span>Enter AR Wallet</span> to <span>Sell ARB</span>',
	homename1: `Today's Profit Ranking`,
	originals: 'Originals',
	More: 'More',
	Menu: 'Menu',
	wingoLng: 'WIN GO Long',
	lotteryResultFive: 'The lottery results for five',
	eTournament: 'e-Tournament',
	Partinturnmentevnts: 'Participate in tournament events',
	PhysicalEducation: 'Esports',
	LiveVideo: 'Live Video',
	ChessandCards: 'Chess and Cards',
	activities: 'Activities',
	Activityaward: 'Activity award',
	Games: 'Games',
	Richrewardactivities: 'Rich reward activities',
	Invfrndstorvvehugerewards: 'Invite friends to receive huge rewards',
	...
	arbTip3: 'Your AR wallet has not been activated yet',
	arbActive: 'Activate',
	arbTip4: 'AR Wallet',
	arbTip5:
	...
	arbTip6: 'Safe, stable and fast',
	arbTip7: 'How to activate AR wallet',
	arbTip8: 'AR wallet features',
	abbTip9: 'You only need<span>{0}</span>to withdraw the balance to AR Wallet',
	arbTip10:
		'When you want to play games, you can quickly recharge to the <span>{0}</span>platform through AR Pay, with the recharge process taking only 5 seconds to complete',
	arbTip11:
	...
	arbTip12: `This method reduces your bank transaction issues while you are playing, so you don't need to worry about bank limits. You just need to sell to UPI when you need to use the funds.`,
	c2cMBAIntegeriOS: 'Deposit amount must be an integer of %d',
	c2cNEWUPIWiOS: 'Use UPI to withdraw money, every withdrawal is rewarded with an additional %.0f%@ bonus',
	highestRebateiOS: 'Permanent commission<span>up to</span>%d%@',
	instructionsDesc1ios: 'Minimum deposit: %d , deposits less than %d will not be credited',
	underDevelopment: 'Under Development',
	tip6digitVeriCodeios: 'Please enter the %@ %d-digit verification code',
	tipemaildigitVeriCodeios: 'Please enter the 6-digit verification code of email address %@',
	arbTip13: 'My ARB',
	lowerRrebateios: '%@ level lower level commission rebate',
	tipTop20RankingAdditionalRewordsios: 'TOP20 commission rankings will be randomly awarded with %@ a separate bonus',
	tipInterpretationRightSavedios: 'The final interpretation of this activity belongs to %@',
	promotionRuleDesc6ios: `The calculation of yesterday's commission starts every morning at %@. After the commission calculation is completed, the commission is rewarded to the wallet and can be viewed through the commission collection record.`,
	abbTip9ios: 'You only need<span>%@</span>to withdraw the balance to AR Wallet',
	arbTip10ios:
		'When you want to play games, you can quickly recharge to the <span>%@</span>platform through AR Pay, with the recharge process taking only 5 seconds to complete',
	wordWithdrawalios: 'Single withdrawal amount range from %@~%@',
	instructionDesios: 'Need to bet %@ to be able to withdraw',
	c2cFTip1ios: 'Use%@，every withdrawal gives an extra%@bonus；',
	highestRebateNewiOS: 'Permanent commission<span>up to</span>%d%@',
	localeChangeMessage:
		'The Application language has been successfully updated. For the changes to take effect, The application will be exited, please relaunch the application. Thank you!',
	changeImage: 'Change Image',
	rechargeQRTip: 'Recharge only once',
	...
	popularTitle: 'Recommended Games',
	...
	code8123: 'ARPay Cash Back',
	code1002: 'This invite code is no longer available. Please use another invite code.',
	compDetails: 'Complaint Details',
	prssResult: 'Process result',
	appealProcessed: 'Your appeal is being processed',
	uploadedSrnSts: 'Uploaded payment screenshots',
	msg: 'Message',
	stapl: 'Submit appeal',
	PaymtScrenShot: 'Upload payment screenshots',
	fileSize: 'Please upload JPG/PNG images smaller than 10MB',
	prblmslveMsg: 'You can leave a message to tell us and we will handle the problem faster',
	succsAppeal: 'We will deal with your problem as quickly as possible',
	payAttn: 'Please pay attention to the processing results of the recharge order list',
	isPending: 'is pending',
	isProcessed: 'has been processed',
	appl: 'Your appeal',
	pRPT: 'Process result : Processing Type',
	pRP: 'Process Result : Paid',
	pRUEr: 'Process Result : 2UTR error',
	aplBtn: 'Appeal',
	applSubDetails: 'Appeal Submitted (view Details)',
	VwDtls: 'View Details',
	PrssType: 'Processing Type',
	Paid: 'Paid',
	UTRErr: '2UTR error',
	serverTicket: 'Customer Service',
	code8124: 'Join channel rewards',
	code147: 'Wrong account or password',
	pwaInstall: 'Installation instructions',
	pwaText1: 'Click',
	pwaText2: 'Slide to find',
	pwaText3: 'Add to home screen',
	pwaText4: 'Access from desktop after adding',
	noRechargeGame1: 'This game requires recharge to enter',
	noRechargeGame2: 'Do you want to recharge immediately to play the game?',
	code1003: 'Game requires recharge to enter',
	rechargeNow: 'Recharge now?',
	partnerTip: 'If you invites player A, with in ',
	partner1: 'When Player A',
	partner2: 'You get bonus',
	partner3: 'and Turnover',
	deposit1: '1st deposit',
	deposit2: '2nd deposit',
	deposit3: '3rd deposit',
	deposit1a: '1st deposit amount',
	deposit2a: '2nd deposit amount',
	deposit3a: '3rd deposit amount',
	turnover: 'Turnover',
	partnerTip1: 'Each deposit is eligible for only one bonus.',
	bounsReceived: 'bonus received',
	code1004: 'The Device has been forbidden registered',
	code350: 'No matching game channel',
	code351: 'Game channel not configured',
	code352: 'Game channel is closed',
	code353: 'Game channel is under maintenance',
	code354: 'The vendor does not support this currency',
	code355: 'The Merchant has been disabled',
	code356: 'The Agent has been disabled',
	code357: 'The Agent does not exist',
	code358: 'The Merchant does not support this game vendor',
	code359: 'This game vendor of the merchant has been closed',
	code360: 'The game vendor of this merchant is under maintenance',
	code361: 'The sub-game is under maintenance',
	code362: 'This sub-game does not support this currency',
	code398: 'The vendor is closed',
	task1: 'Cycle',
	task3: 'Invite Task',
	task4: 'Bet Task',
	task5: 'Deposit Task',
	task6: 'Activity Task',
	report: 'Submit Receipt',
	safeG: 'Do you want to go?',
	yes: 'yes',
	no: 'no',
	go: 'go',
	safeT: 'requires {0} times turnover for  withdraw after thansfer out',
	code1006:
		"If you haven't recharged for 2 months, you need to recharge to receive the reward <br/> VIP1 (Recharge 100) Activate <br/> VIP 2 (Recharge 200)Activate <br/> VIP 3 (Recharge 300)Activate <br/> VIP4 and above enjoy lifetime benefits",
	gameT: 'Minimum recharge {0} to enter',
	sxf: 'Amount range <span class="red">{0}-{1}</span> withdrawal fee available',
	sxf1: 'Withdrawal fee <span class="red">{0}%</span>',
	code1007: 'Gift code is expired',
	safeNewTip: 'maximum total revenue',
	safeNewTip2:
		'With guaranteed income, you can transfer out at any time, from the balance of the safe to the balance of the wallet, the entire amount must be transferred',
	dailyRateReturn2: 'Half-hour interest rate {0}%, earnings calculated once every {1} minutes',
	tipMinimumIncome2: 'Minimum return, half hour rate',
	dailyRate2: 'Half hour interest rate',
	checkSafeBox: 'No more reminders in 30days',
	code1008: `Today's transfer limit reached`,
	code1009: 'Withdrawals are restricted. For more details, please contact the manager or online customer support.',
	RNSActive: 'Activate RSN Wallet',
	rnsNoActive: 'Your RSN Wallet is not activated yet',
	RSNTip: 'My RSN',
	rsnRecharge: 'RSN Recharge',
	rechargeSuccess: 'recharge success',
	activityTip9: 'Qualified members can manually apply for bonuses on this page',
	clanding: 'Copy landing page link',
	code44: 'Bet is not authorized, please contact the administrator',
	emptyPassword: 'Password cannot be empty',
	code1012: 'There is no negative profit reward for the first deposit.',
	code1013: 'Does not meet the conditions for applying for the first deposit negative profit reward',
	code1014: 'Incorrect first deposit negative profit bonus status',
	brazildialog1: 'Verify your age to enter.',
	brazildialog2: 'I AM OVER 18 YEARS OLD',
	brazildialog3: 'I AM UNDER 18',
	brazildialog4: 'We only provide services to people over 18 years old.',
	gogame1: 'Get additional bouns in solts.',
	code617: 'Ongoing order not completed',
	code618: 'Order amount should be hundreds',
	code619: 'Recharge channel is not correct',
	code620: 'Place order timeout, try another order amount',
	code621: 'Third system fail',
	code622: 'Order cant not appeal again',
	'common.code_-1': 'None',
	...
	'common.code_44': 'Betting is prohibited',
	...
	'common.autoClose': '3s Automatic Shutdown',
	'common.issue': 'Period',
	'common.loseTips': "It's a pity",
	'common.nowin': 'No Win',
	...
	'Game history': 'This account has been logged in elsewhere',
	'common.prize': 'Game history',
	'common.chart': 'Chart',
	'common.records': 'My history',
	'common.w10':
		'In order to protect the legitimate rights and interests of users participating in the pre-sale and maintain the normal operating order of the pre-sale, these rules are formulated in accordance with relevant agreements and laws and regulations. country Chapter 1 Definition1.1 Pre-sale definition',
	...
	'bet.small': 'Small',
	'bet.big': 'Big',
	'common.trx1': 'Issue Number',
	'common.trx2': 'Block Height',
	'common.trx3': 'Block Time',
	'common.trx4': 'Hash Value',
	'common.trx5': 'Result',
	'common.betContent': 'Please select the bet content!',
	strategyTitle: 'Betting Strategy',
	strategyHistory: 'History',
	strategyTip: 'Please select a strategy',
	followed: 'followed',
	...
	stLose: 'Lose',
	stWin: 'Win',
	sb: 'Strategy benefits',
	bron: 'Remaining Rounds',
	waaw: 'wager after a win',
	waal: 'wager after a loss',
	wtem: 'Whether to enable martingale',
	margin: 'Margin',
	tpa: 'Take profit amount',
	sla: 'Stop loss amount',
	emore: 'Expand more',
	stopStrage: 'Stop strategy',
	fts: 'Follow Strategy',
	betA: 'Bet Amount',
	betR: 'Round',
	betSp: 'Strategy parameters',
	tryIt: 'Try it',
	Tron: 'Total Rounds',
	Treve: 'Total revenue',
	ManualClose: 'Manual shutdown',
	StopProfit: 'Take profit',
	StopLoss: 'Stop loss',
	NotEnoughMarginAmount: 'Insufficient margin',
	IssueCountFinish: 'Rounds completed',
	ExceedLimit: 'Single-period excess limit',
	GameMaintenance: 'Game maintenance',
	NetworkAnomaly: 'Network abnormality',
	PlanStopped: 'Policy deactivation',
	DisableBet: 'Betting is prohibited',
	strageSet: 'Strategy settings',
	hstrage: 'Historical strategy',
	prule: 'Policy Rules',
	promptT: 'Prompt',
	ruleT11: 'Total Betting Amount using the Strategy',
	ruleT21: 'Best Historical Return on Investment using the Strategy',
	ruleT31: 'Total Profit of Users who Profited from the Strategy',
	ruleT41: 'Only one strategy can be enabled at a time. Do you want to terminate the current strategy?',
	verify1: 'Bet amount is required',
	verify2: 'Bet amount must integer',
	verify3: 'Round is required',
	verify4: 'Round must be a positive integer between 1 and 1000',
	verify5: 'Insufficient balance,bet amount is too large',
	verify6: 'Below minimum bet amount',
	pickUp: 'pick up',
	code415: 'Follow plan does not exist',
	code416: 'Only one strategy order can be added per issue',
	code417: 'Only one follow can be opened for the same game',
	code418: 'Quick bet configuration does not exist',
	code419: 'Invalid bet amount',
	code420: 'Margin must be greater than bet amount',
	code421: 'Failed to deduct margin',
	code422: 'Failed to insert follow record',
	code423: 'Exception occurred while adding follow record',
	code424: 'Follow record does not exist',
	code425: 'Failed to return margin',
	code426: 'Failed to update follow record',
	hint1: 'Enter bet amount',
	hint2: 'Enter round number',
	hint3: 'Please enter margin',
	hint4: 'Please enter profitAmount',
	hint5: 'Please enter lossAmount',
	hint6: 'Settlement in progress',
	hint7: 'Successful follow-up investment strategy',
	hint8: 'Stop follow-up investment success',
	code427: 'Failed to stop follow record',
	InsufficientMarginOrBalance: 'Insufficient margin/balance',
	code428: 'The tenant not enabled strategy follow',
	Appeal: 'Appeal',
	notice: 'Notice',
	appealTip:
		'Please contact customer service within 48 hours after filling in the appeal, otherwise the platform will handle it based on specific circumstances.',
	ReasonFAppeal: 'Appeal Reason',
	sellTip3: 'Please enter the appeal reason',
	selltip4: 'Submit Appeal',
	submitting: 'Submitting...',
	Submitted: 'Submitted',
	buyAppeal: 'Buy Appeal',
	xg84: 'Automatic appeal tutorial:',
	xg85: '1. The platform only supports the following wallets for automatic KYC appeals;',
	xg86: '2. If you use the following wallets for payment transfer, you can select the wallet you use and receive the OTP to automatically appeal to the system;',
	xg87: '3. After completing the link through OTP, if you are transferring money for real, the system will automatically complete the order for you',
	xg88: 'Please select the wallet you use to pay:',
	xg89: 'If you do not use the following wallets to pay, please select "Other Wallets"',
	xg90: 'Other wallets',
	xg91: 'Linked wallet',
	xg19: 'The mobile number format is incorrect',
	xg22: 'Link Success',
	pSelectKyc: 'Select the kyc partner',
	sellTip15: 'Please upload a minimum of 1 and a maximum of 3 proof images.',
	pphone: 'Please enter your phone number.',
	pcode: 'Enter Verification Code',
	nextSte: 'Next',
	cancelOrder: 'Cancel',
	sellTip18: 'Please fill in other reasons',
	SubmittedS: 'Submission Successful',
	addCancelDes: 'Please fill in the cancellation reason',
	cancelBuy: 'Cancel Transaction',
	cancelTip1: 'If you have successfully transferred funds to the other party',
	cancelTip2: 'please do not cancel the transaction.',
	cancelSuccess: 'Cancellation Successful',
	sellTip13: 'Please upload images ({0}/3)',
	vsImg: 'View sample images',
	sellTip14: 'Image size cannot exceed 5M',
	upLoaderL: 'Uploading...',
	VerificationCode: 'Verification Code',
	placeholderTip: 'Please enter content',
	sellTip70: 'Phone number cannot be empty',
	customerService: 'Customer Service',
	sellTip71: 'Email cannot be empty',
	sellTip72: 'Incorrect email format',
	sendSuc: 'Sent successfully',
	Waiting: 'Awaiting processing',
	Matching: 'Matching',
	ToBePaid: 'Awaiting payment',
	WaitingC: 'Awaiting confirmation',
	uploadC: 'Upload voucher',
	sellTip16: 'Please upload a video ({0}/1).',
	vsVideo: 'View sample video',
	sellTip17: 'The video must be less than 50MB.',
	UploadVideo: 'Upload Video',
	phoneNumber: 'Phone Number',
	uploadImage: 'Upload Image',
	UploadSuccessful: 'Upload Successful',
	code429: 'Follow record has stopped',
	hint9: 'Please enter the Martingale multiplier',
	mating: 'Martingale multiplier',
	arupiPayError: 'Please enter an integer multiple of the amount',
	arupiPayTip: 'In order to improve your recharge success rate, we recommend several recharge amounts for you',
	arupiOrderTip: 'An order you placed on the upipay channel is temporarily uncompleted. Do you need to cancel the order?',
	arupiAppealTip: 'Your KYC has been disconnected. Please reconnect to continue the appeal',
	resubmit: 'Resubmit',
	haveProgressOrderTip: 'The channel is confirming the payment, please wait patiently.',
	jackEnter: 'ENTER',
	Chances: 'Chances',
	supportedMethods: 'SUPPORTED PAYMENT METHODS',
	followUs: 'FOLLOW US',
	rajaText:
		'RAJA GAMES is owned and operated by Medium Rare India Pvt. Ltd., registration number: U12345KA2024PTC123456, registered address: 123 MG Road, Bengaluru, Karnataka, India. Contact us at support@rajagames.com. Payment agent company is Medium Rare Limited with address 45 Park Street, Level 3, Kolkata, West Bengal, India, and Registration number: HE 410775.',
	pServer: 'Please contact customer service.',
	winningAmountRaja: 'The member has won this much of money Rs:',
	haveAppealTip: 'There is an order under appeal, and deposit cannot be initiated again',
	arupiCopy: 'Copy successful ! Remember to back fill the UTR !',
	unSubmitUtr: '(UTR not entered)',
	code623: 'You have been banned from recharging due to frequent cancellations, please contact customer service',
	code624:
		'You have been banned from recharging due to abnormal recharging behavior, please contact customer service to lift the ban',
	arupiOrderTip2: 'You still have an order that has not been completed, Please complete it first!',
	arupiOrderTip3:
		'Since we have not received the UTR you filled in at the arupi channel cashier, if you do not fill in the UTR, the recharge will not be successfully received. You can submit your recharge UTR certificate through appeal!',
	submitUtr: 'Submit Utr',
	utr: 'Utr',
	submitUtrtip:
		'After submitting UTR, if the review is successful, the recharge will normally be credited to the account within 30 minutes. If it is not credited within 30 minutes',
	code708: 'UTR submission times exceed limit',
	code8125: 'Recharge Replenishment',
	goarWithdraw: 'ARB Withdraw',
	code8126: 'Withdrawal Reward',
	code709: 'Actual amount is less than KYC amount',
	rechargeMethod: 'Recharge Method',
	moto1: 'Betting Area',
	moto2: 'Select {0} number',
	moto3: 'Odd or Even',
	moto4: 'Select the rank number as odd or even',
	moto5: 'Big or Small',
	moto6: 'Select the rank number as Big (6&over) or Small (under 6)',
	moto7: 'Bet, {0} to return {1}',
	moto8: 'In the competition',
	betStart: 'Bet Start',
	betEnd: 'Bet end',
	moto9: 'Bet on the top three',
	moto10: 'Motorace in progress...',
	motoTip1: 'Winning',
	motoTip2: 'No Winning',
	motoTip3: 'winning results',
	motoTip4: 'Current period',
	motoTip5: 'GO it',
	BigSmall: 'BigSmall',
	Color: 'Color',
	red: 'red',
	...
	violet: 'violet',
	issueTips: 'Issue {0}',
	braTips1: 'Access by individuals under 18 years of age is strictly prohibited.',
	braTips2:
		'The brand ({0}.COM) is operated by the Brazilian company ONEPAY MEIOS DE PAGAMENTO, in partnership with LOTERJ, starting from 10/04/2024, registered under No. SEI 150013/001113/2024.',
	braTips3: 'For legal matters, please contact：{0}',
	arupiTitle: 'ARPAY Bonus Guide',
	code613: 'Channel does not exist',
	code710: 'Your top-up function has been disabled by the channel, please contact our customer service.',
	arupiRemark: 'This order has been frozen by the system, Please contact customer service.',
	arupiBank: 'Submit Deposit Voucher',
	arupiKyc: 'KYC relink',
	arupiKycTip: 'Automatically confirming',
	UPIIDNotSame: 'Confirm that UPI ID is inconsistent with UPI ID',
	confirmAccountNo: 'Confirm that the UPI ID format is incorrect',
	arbbuy: 'There is no corresponding recharge amount available. Please go to AR Wallet to buy ARB',
	arupiOrderTip4:
		'You did not fill in the UTR and the order could not be completed successfully. You can link KYC to automatically complete the order',
	VideoWinGoTip: 'Live Number Result',
	VideoWinGoTip2: 'Guess Number, Colour, Odd/Even, or Size to win',
	payme: 'I have paid',
	paymeConfirm: 'If you have successfully transferred funds，please do not cancel the transaction!',
	subutr: 'Fill in UTR',
	utrpay: 'I want to cancel this order. Click',
	enterUtr: 'Please enter UTR',
	PaymentInvalid: 'Payment Invalid',
	PaymentExpired: 'The payment order has expired',
	orderAppealed: 'Your order is being appealed',
	orderAppeal: 'Your order is being Appeal',
	orderWait: 'Please wait...',
	otherWllets: 'Other wallets',
	previousStep: 'Previous step',
	welcomAuthorize: 'Welcom Authorize',
	enjoyWork: 'Let us enjoy the work',
	enterYournumber: 'Enter your {0} number',
	nextTip: 'Click the“Next”button to proceed',
	paymentSuccessful: 'Payment successful',
	paymentCompleted: 'Your payment has been completed',
	formatIncorrect: 'UTR format is incorrect',
	remainingTime: 'Remaining payment time',
	choosePay: 'Choose a payment method to pay',
	scanPay: 'Use Mobile Scan code to pay',
	scanPayTip: 'Please use another device to scan the QR code with your payment app',
	deviceQR: "If you scan the QR code from this device's gallery, the payment amount may be limited (≤2000)",
	inputUTR: 'Input UTR/ Paste UTR',
	fillUTR: 'If you do not back fill UTR/ paste UTR, 100% will fail',
	inputDigits: 'Input 12 digits here',
	importantReminder: 'Important reminder',
	sameLink: 'Do not pay for the same link repeatedly!',
	paytmUp: 'Paytm is wake up support!',
	returnMerchant: 'Return to merchant',
	submitSuccessfully: 'Submit Successfully',
	untilConfirm: 'Please wait until we confirm your payment.',
	safetyTip:
		'For the safety of your funds, when using Paytem App to pay, please make sure that the payment address is consistent with the cash register',
	platformArrival: 'The platform only supports the following wallets for KYC self-confirmation of account arrival',
	followingWallets:
		'If you use the following wallets for payment transfer, you can select the wallet you use and receive OTP for automatic system confirmation',
	throughOTP:
		'After completing the connection through OTP, if you are transferring money for real, the system will automatically help you complete the order and add points',
	orderNotCompleted: 'Order not completed',
	transferredOrder: 'I have transferred money to this order',
	continuePurchase: 'I want to continue to complete this purchase',
	t572: 'My Amount',
	t573: 'CASH OUT',
	t574: 'INVITE FRIENDS TO GET SPIN',
	t575: 'Only {0} left to get prize {1}',
	t285: 'Record',
	t587: 'Add <span>{0}</span> to balance',
	t583: 'Cash out request submitted successfully',
	ok: 'OK',
	t577: 'You need {0} more to cash out',
	t576: 'Insufficient amount',
	t578: 'Cash everyday',
	t579: 'Choose your reward',
	t586: 'Cash out',
	t589: 'Wheel Cash Out History',
	inviteWheel: 'Invite Wheel',
	t126: 'Processing',
	t590: 'Withdrawing',
	code8130: 'Invite Wheel Reward',
	t588: '{0}x turnover required to withdraw',
	luckyWheel: 'Invite Wheel',
	code1017: 'The invite turntable activity has not been opened',
	code1018: 'Invite turntable lottery failed',
	code1019: 'No available draws',
	code1020: 'The lottery amount has reached the withdrawal amount',
	code1021: 'Withdrawal amount must be greater than 0',
	code1022: 'No available invite turntable record',
	code1023: 'Withdrawal amount does not meet the conditions',
	code1024: 'Invite turntable withdrawal failed',
	code1025: 'Invite turntable withdrawal successful',
	e1: 'Download page',
	e2: 'Quick installation',
	e3: 'Complete Installation',
	e4: 'Default Page',
	e5: 'The download package is not yet available. Please check back soon!',
	e6: 'Installation Tutorial',
	e7: 'For iOS users, please refer to the following installation steps.',
	e8: 'Private Installation',
	getMoney: 'Get {0}',
	downAppRechargeReward: 'Top up {0} Get {1}',
	withdrawAmount: 'Please enter the Withdrawal amount in hundred',
	withdrawQrcodeTips: 'Please upload the QR code for payment',
	withdrawQrcode: 'upload QR code for payment',
	upiImg: 'UPI payment QR code information is inconsistent with UPI ID',
	upiUploadImg: 'UPI payment QR code upload error, please upload again',
	code806: 'You need to bind your {0} withdrawal account before you can participate in the tournament',
	code625: 'Your payment attempts are too frequent. Please complete your existing payment orders or contact customer support',
	downReceiveText1: 'Congratulations on downloading the APP and completing the recharge',
	downReceiveText2: 'Meet event conditions',
	downReceiveText3: 'Special gift to you',
	code1026: 'The reward has expired',
	code8131: 'Download Bonus',
	...
	washingCode: 'Washing Code Rebate',
	withdrawalRewards: 'Withdrawal Rewards',
	newMembersRewards: 'New Members Bonus for Losing Profits',
	noReceiveMethod: 'No method available for receiving the content yet',
	receiveIng: 'Receiving',
	code1027: 'You have an order that is being processed. Please wait for it to be approved before submitting.',
	code198: 'Sending text messages has been restricted today',
	downloadFileiOSError: 'iOS currently does not support downloading this application',
	isStandard: 'The current activity reward does not meet the requirements',
	code807: 'During the event, place a bet of {2} in the 【{0}】-【{1}】 games to participate in the competition',
	installBar: 'install',
	barInfo1: 'Download our APP and win',
	barInfo2: 'super prizes!',
	goToLogin: 'Click to login',
	chooseBankWarmTips:
		'The system detects that you IFSC code can be matched with the following banks. Please select the bank you want to bind.',
	gpV: 'Verified by play protect',
	l2R: 'reviews',
	l2D: 'Downloads',
	l2EC: 'Editors’ Choice',
	l3RI: 'Rapid Install',
	l3GP: 'Go to play',
	l3DW: 'Download within 10s',
	l4S: 'Share',
	l4AW: 'Add to wishlist',
	aboutAPP: 'About this app',
	upd: 'Updated on',
	slots: 'slots',
	ds: 'Data safety',
	dsT: 'Safety starts with understanding how developers collect and share your data. Data privacy and security practices may vary based on your use, region, and age. The developer provided this information and may update it over time.',
	dsND: 'No data shared with third parties',
	dsLM: 'Learn more',
	dsLR: 'about how developers declare sharing',
	dsC: 'This app may collect these data types Location, App activity and 2 others',
	dsE: 'Data is encrypted in transit',
	dsD: 'You can request that data be deleted',
	rt: 'Ratings and reviews',
	rtT: 'Ratings and reviews are verified and from people who use the same type of device that you use',
	devP: 'Phone',
	devT: 'Tablet',
	rCount: '10000',
	r1N: 'Arun Ayyangar',
	r1D: 'December 21, 2024',
	r1T: "This casino is always adding new features and games which keeps me exploring new games. It can be seen that they are committed to the players' gaming experience, which is very good and reliable.",
	r2N: 'Mahava Kashyap',
	r2D: 'December 25, 2024',
	r2T: 'This platform often gives out big prizes, I highly recommend it',
	r3N: 'Jeet Bhattacharya',
	r3D: 'October 24, 2024',
	r3T: 'Withdrawals arrive quickly, and I also get rewards for sharing with friends, which is great.',
	b1: 'Play Pass',
	b2: 'Play Points',
	b3: 'Gift cards',
	b4: 'Redeem',
	...
	b7: 'Parent Guide',
	b8: 'Family Sharing',
	b9: 'Terms of Service Privacy',
	b10: 'Developers English',
	m1: 'Quick Installation',
	m2: '6 times faster',
	m3: 'Activated',
	m4: 'Install',
	verifyOpt: 'OTP Verify',
	quickTips:
		'The system has detected that your UPI account for receiving payments may contain a mobile phone number, posing a risk of leakage. To prevent fraud, we recommend that you change to a UPI account that does not include a mobile phone number.',
	quickTips2:
		'If you insist on using your current account, do not trust scammers impersonating customer service representatives and do not send your OTP to anyone. The platform will not request OTPs from any user!',
	changeAccount: 'Change Account',
	continueAccount: 'Continue Using Current Account',
	currentChange: 'Change to Current Account',
	currentPayment: 'Current Payment',
	paymentTips: 'To ensure account security, we need to verify your ownership of the following account.',
	qrupiId: 'The UPI ID does not match the payment QR code. Please upload it again',
	paymentMethods: 'Payment Method',
	currentPaymentTips:
		'The system has detected that you have a withdrawal and need to obtain SMS verification again before you can withdraw normally.',
	code626: 'Three-party parameter verification failed',
	code627: 'Three-party channel not enabled',
	code628: 'Merchant information does not exist in the third-party system',
	code629: 'KYC information verification failed and requires re-verification',
	code630: 'Merchant balance insufficient',
	code631: 'Seller member does not exist in the third-party system',
	code632: 'Seller member disabled in the third-party system',
	code633: 'Seller member status abnormal in the third-party system',
	code634: 'SMS parameter authentication failed',
	code635: 'OTP sending failed',
	code636: 'SMS verification code requests too frequently',
	code637: 'OTP invalid',
	code638: 'KYC interface request failed',
	code639: 'Verification code sending failed, please try again',
	newRegisterTip: 'Welcome, new friend',
	newRegisterPrompt: 'Registration successful',
	newRegisterGift: 'Bonus! {0}x wager to cash out!',
	code1028: 'Game requires recharge to enter',
	code1029: 'The number of withdrawals has reached the limit today, please come back tomorrow',
	code1030: 'The requirement does not meet to claim this event, contact superior agent for assistance',
	code1031: 'Not eligible yet. A higher total deposit is required to join',
	code1032: `This tier has hit today's purchase limit. Try another tier or come back tomorrow`,
	code289:
		'The Maximum Number of Bank Cards Linked to This Phone Number Has Been Reached. Please Use a Different Phone Number to Link.',
	code199: 'Your Account Cannot Withdraw at the Moment. If You Have Any Questions, Please Contact Customer Service.',
	code286: 'The bankcode cannot be empty',
	code287: 'Kyc status is offline',
	code288: 'Upi Id can not match',
	refuse_firebase_notify: 'Please authorize notification permissions to receive important messages',
	reBenefits1: 'Recharge Bonus for return',
	reBenefits2: 'Once missed, never to return',
	reBenefits3: 'You have successfully participated in this event.',
	reBenefits4: 'Bonus Percentage for Top-Up',
	reBenefits5: 'Maximum Bonus Amount',
	reBenefits6: 'The benefit has been added to your 【Wallet】 balance.',
	reBenefits7: 'Time remaining',
	reBenefits8: 'The bonus amount is',
	reBenefits9: 'Top-up Now',
	reBenefits10: 'Limited time',
	treasureChest1: 'Congratulations on completing the daily ({task}) reward task',
	treasureChest2: 'Open the treasure chest to get {amount} bonus',
	treasureChest3: 'Open chest',
	treasureChest4: 'Get {amount} bonus',
	treasureChest5: 'Congratulations on completing the weekly ({task}) reward task',
	code8134: 'Return to New Recharge Reward',
	code8134: 'Returning Member New Recharge Bonus',
	code8135: 'Coupon Bonus',
	code8136: 'Weekly Card Purchase',
	code8137: 'Monthly Card Purchase',
	code8138: 'Weekly Card Reward',
	code8139: 'Monthly Card Reward',
	pin: 'PIN code',
	enterPin: 'Please enter your PIN code',
	pinFormatError: 'Please enter a 4-digit PIN code',
	code1040: 'Claim limit reached. Please upgrade VIP level or contact your mentor',
	code1047: 'This coupon is only available to members who have not made a deposit yet',
	payNameTip: 'Please enter the correct name for this payment account (must match the bank account holder’s name).',
	payPrivacy:
		'The platform will not store or disclose your personal information and will only use it for this payment verification.',
	payNameErrorHint: 'If the name is entered incorrectly, it may result in:',
	payOrderFail: 'The top-up order cannot be confirmed automatically',
	payCallbackFail: 'The third-party payment callback may fail',
	payManualDelay: 'Manual processing will be required and the arrival time will be delayed',
	payRecheck: 'Please double-check before submitting',
	playNow: 'Play Now',
	arSport: 'AR Sports',
	upi_tip_safe_title: 'Security Notice:',
	upi_tip_safe:
	...
	eventRewardsLoginTitle: 'Event Rewards',
	eventRewardsLoginDescriptionPrefix: 'Log in to participate in the ',
	eventRewardsLoginDescriptionHighlight: 'event rewards',
	eventRewardsLoginDescriptionSuffix: ' and unlock all 8 exclusive rewards',
	eventRewardsLoginPrimary: 'Log in now to participate',
	eventRewardsLoginSecondary: "Don't log in yet, continue browsing",
	charAtone: 'The first digit must be 0',
	viewWorkOrderProgress: 'View Work Order Progress', // 充值记录-查看工单进度
	actualCredit: 'You get',
	...
	notifyClaim: 'Claim',
	notifyLater: 'Later',
	notifyReconnectNow: 'Reconnect now',
	notifyImportantNotice: 'Important Notice',
	notifyImportantNoticeMessage:
		'The bank you selected, {bankCode}, may require two-factor authentication. Please remain online on the platform for 15–30 minutes after submitting your request.',
	notifyImportantNoticeSecondary: 'If you miss two verification attempts, this withdrawal may fail.',
	notifyCancel: 'Cancel',
	notifySubmit: 'Submit',
	notifyViewWallet: 'View Wallet',
	notifyWithdrawAgain: 'Withdraw Again',
	notifyCountdown: 'Countdown: {time}',
	kycCountdownVerifyTitle: 'Complete verification before the countdown ends, otherwise this withdrawal will fail!',
	notifyStayingMinutes: 'Staying at least 15 minutes',
	notifyWithdrawReturnedTip:
		'Please resubmit your withdrawal request. We recommend staying in the app for 15–30 minutes after submitting it.',
	notifyCenterTitle: 'Notification Center({n})',
	notifyExpand: 'Expand',
	notifyCollapse: 'Collapse',
	notifyJustNow: 'Now',
	notifyMinutesAgo: '{n} minutes ago',
	notifyHoursAgo: '{n} hours ago',
	notifyDaysAgo: '{n} days ago',
