export default {
	exclusiveCouponsClaim: 'Eksklusibong kupon ({0})· Angkinin sa pagrehistro',
	couponNoThreshold: 'Walang minimum',
	couponThreshold: 'Mula {0}',
	couponValidDays: '{0} araw',
	couponUpperLimit: 'Hanggang {0}',
	couponRechargeName: 'Kupon sa deposito',
	...
	couponArrivalTitle: 'Eksklusibong kupon sa deposito',
	couponArrivalSubtitle: 'Binigyan ka ng operasyon ng {0} kupon sa deposito',
	couponMaxReturns: 'Deposit bonus {0}%',
	couponClaimNow: 'Angkinin ngayon ({0})',
	myRechargeCoupon: 'Aking mga kupon sa deposito',
	couponUnused: 'Hindi pa nagamit',
	couponUsed: 'Nagamit na',
	couponExpired: 'Nag-expire na',
	couponGoUse: 'Gamitin',
	redeemNoteTitle: 'Mga Paalala sa Pag-redeem',
	redeemNote1: 'Isang code para sa isang regalo. Direktang idinadagdag ang cash; ang mga kupon ay mapupunta sa "Aking mga kupon sa deposito".',
	redeemNote2: 'Ang mga kupon ay may minimum na halaga at panahon ng bisa, gamitin ang mga ito bago mag-expire.',
	...
	shareToOtherApps: 'Ibahagi sa ibang app para mag-imbita ng kaibigan',
	urgeOrder: 'Madaliin ang Order',
	urgeOrderSuccess: 'Ang iyong kahilingan ay naipadala sa responsableng espesyalista. Aayusin namin ang iyong isyu sa lalong madaling panahon. Mangyaring maghintay nang matiyaga. Salamat sa iyong pag-unawa at suporta',
	...
	firstBindNameLockTip:
		'Ito ang iyong unang account para sa pagtanggap ng pera. Mala-lock ang pangalan pagkatapos i-save, at lahat ng susunod na paraan ng withdrawal ay dapat gumamit ng parehong pangalan.',
	...
	code1047: 'Ang kupon na ito ay para lamang sa mga miyembro na hindi pa nakakapag-deposito',
	...
	wrongTel: 'Nomor ng telepono ay hindi wasto. Mangyaring maglagay ng wastong numero.',
	...
	onConfirmMsg4: 'Ang haba ng USDT address ay hindi dapat lumampas sa 36 character',
	...
	xosoTxt2:
		'If the voting number is matched with any set of the last set of the number of numbers in the position of the lottery results, it is a winning. The winning number is more than one, and the amount of winning will double.',
	...
	upiInstructions1:
		'After completing the UPI transaction, please fill in Ref NO./utr If you do not fill in UTR, the loss of the company is not responsible, please be sure to fill it back!',
	...
	totalValidBets:"",
	Bonus: "",
	t572: 'ang halaga ng aking',
	t573: 'CASH OUT',
	t574: 'MAG-IMBITA NG MGA KAIBIGAN PARA MATANGGAP NG PERA',
	t575: '{0} na lang ang natitira upang makakuha ng premyo {1}',
	t285: 'Itala',
	t587: 'Idagdag ang <span>{0}</span> sa balanse',
	t583: 'Matagumpay na naisumite ang kahilingan sa cash out',
	ok: 'OK',
	t577: 'Kailangan mo ng {0} pa para makapag-cash out',
	t576: 'Hindi sapat na halaga',
	t578: 'Cash araw-araw',
	t579: 'Piliin ang iyong gantimpala',
	t586: 'Cash out',
	t589: 'Kasaysayan ng Wheel Cash Out',
	inviteWheel: 'Imbitahan si Wheel',
	t126: 'Pinoproseso',
	t590: 'Pag-withdraw',
	t588: "{0} beses na turnover ay maaaring i-withdraw.",
	luckyWheel: 'Masuwerteng Ruweda',
	downReceiveText1:"Binabati kita sa pag-download ng app at pagkumpleto ng iyong deposito.",
	downReceiveText2:"Matugunan ang mga kundisyon ng kaganapan",
	downReceiveText3:"Espesyal na regalo para sa iyo",
	bonusDetails:"Detalye ng Bonus",
	todayRewards:"Bonus ngayon",
	totalRewards:"Kabuuang bonus",
	bonusCollection:"Koleksyon ng mga bonus",
	washingCode:"Turnover para mag-withdraw",
	withdrawalRewards:"Mga reward sa withdrawal",
	newMembersRewards:"Bagong bonus ng miyembro para sa pagkatalo ng pondo",
	noReceiveMethod:"Wala pang magagamit na paraan upang matanggap ang nilalaman.",
	receiveIng:"Pagtanggap",
	code1027:"Mayroon kang isang order na pinoproseso. Pakihintay na maaprubahan ito bago isumite.",
	e1: "I-download ang pahina",
	e2: "Mabilis na pag-install",
	e3: "Kumpletuhin ang Pag-install",
	e4: "Default page",
	e5: "Hindi pa available ang download package. Mangyaring bumalik sa lalong madaling panahon!",
	e6: "Tutorial sa pag-install.",
	e7: "Para sa mga gumagamit ng iOS, mangyaring sumangguni sa mga sumusunod na hakbang sa pag-install.",
	e8: "Pribadong Pag-install",
	getMoney: 'Makakuha ng {0}',
	code807: "Sa panahon ng kaganapan, maglagay ng taya ng {2} sa [{0}]-[{1}] na mga laro upang lumahok sa kumpetisyon",
	giftBonus:'Halaga ng Bonus',
	reBenefits1:'Bonus sa Recharge',
	reBenefits2:'Kapag nakaligtaan, hindi na maibabalik pa',
	reBenefits3:'Matagumpay kang nakilahok sa kaganapang ito.',
	reBenefits4:'Porsyento ng bonus bawat deposito',
	reBenefits5:'Pinakamataas na halaga ng bonus',
	reBenefits6:'Ang benepisyo ay naidagdag na sa iyong balanse ng [Wallet]',
	reBenefits7:'Oras na natitira',
	reBenefits8:'Ang halaga ng bonus ay',
	reBenefits9:'Mag deposito ngayon',
	reBenefits10:'Limitadong oras',
	treasureChest1:'Binabati kita sa pagkumpleto ng pang-araw-araw na gantimpalang gawain ({task})',
	treasureChest2:'Buksan ang baul ng kayamanan para makakuha ng {amount} na bonus',
	treasureChest3:'Buksan ang baul',
	treasureChest4:'Kumuha ng bonus na {amount}',
	treasureChest5:'Binabati kita sa pagkumpleto ng lingguhang gantimpalang gawain ({task})',
	code8134:'Bumalik sa mga bagong recharge reward',
	code8135:'Bonus ng Kupon',
	...
	playNow: "Maglaro Na",
	w8: 'mga istatistika',
	w9: 'Istatistika (huling 100 Panahon)',
	w11: 'Panalong numero',
	downAppRechargeReward: 'Mag-top up ng {0} Makakuha ng {1}',
	eventRewardsLoginTitle: 'Mga gantimpala sa event',
	eventRewardsLoginDescriptionPrefix: 'Mag-log in para sumali sa ',
	eventRewardsLoginDescriptionHighlight: 'mga gantimpala sa event',
	eventRewardsLoginDescriptionSuffix: ' at i-unlock ang lahat ng 8 eksklusibong gantimpala',
	eventRewardsLoginPrimary: 'Mag-log in ngayon para sumali',
	eventRewardsLoginSecondary: 'Huwag munang mag-log in, magpatuloy sa pag-browse',
	charAtone: 'Ang unang digit ay dapat na 0',
	viewWorkOrderProgress: 'Tingnan ang progreso ng work order', // 充值记录-查看工单进度
	actualCredit: 'Nakukuha mo',
	depositBonus: 'Deposit bonus',
	vipReward: 'VIP bonus',
	fee: 'Bayarin',
	youpay: 'Babayaran mo',
	feeRate: 'Rate ng bayarin',
	bonus: 'Bonus',
	notifyClaim: 'Kunin',
	notifyLater: 'Mamaya',
	notifyReconnectNow: 'Ikonekta muli ngayon',
	notifyImportantNotice: 'Mahalagang Paalala',
	notifyImportantNoticeMessage: 'Ang bangko na pinili mo, {bankCode}, ay maaaring mangailangan ng two-factor authentication. Manatiling online sa platform nang 15–30 minuto pagkatapos isumite ang iyong kahilingan.',
	notifyImportantNoticeSecondary: 'Kung makaligtaan mo ang dalawang pagsubok sa pag-verify, maaaring mabigo ang withdrawal na ito.',
	notifyCancel: 'Kanselahin',
	notifySubmit: 'Isumite',
	notifyViewWallet: 'Tingnan ang Wallet',
	notifyWithdrawAgain: 'Mag-withdraw Muli',
	notifyCountdown: 'Countdown: {time}',
	kycCountdownVerifyTitle: 'Kumpletuhin ang pag-verify bago matapos ang countdown, kung hindi ay mabibigo ang withdrawal na ito!',
	notifyStayingMinutes: 'Manatili nang hindi bababa sa 15 minuto',
	notifyWithdrawReturnedTip: 'Pakisumite muli ang iyong kahilingan sa withdrawal. Inirerekomenda naming manatili sa app nang 15–30 minuto pagkatapos itong isumite.',
	notifyCenterTitle: 'Notification Center({n})',
	notifyExpand: 'Palawakin',
	notifyCollapse: 'Tiklupin',
	notifyJustNow: 'Ngayon',
	notifyMinutesAgo: '{n} minuto ang nakalipas',
	notifyHoursAgo: '{n} oras ang nakalipas',
	notifyDaysAgo: '{n} araw ang nakalipas',
	orderAmountLabel: 'Order amount',
	betMulti: 'Multi',
	periodCardWeekTab: 'Weekly Card',
	periodCardMonthTab: 'Monthly Card',
	periodCardPick: 'Pumili ng tier · Bumili ngayon',
	periodCardInstant: 'Instant cashback',
	periodCardDaily: 'Araw-araw',
	periodCardBuy: 'Bumili ngayon',
	periodCardOrigin: 'Orihinal na presyo',
	periodCardNoTier: 'Walang available na tier sa kategoryang ito',
	periodCardBuyWeekTitle: 'Bumili ng Weekly Card',
	periodCardBuyMonthTitle: 'Bumili ng Monthly Card',
	periodCardConfirmInstant: 'Makakakuha ka ng instant cashback',
	periodCardConfirmDaily: 'Araw-araw kang makakatanggap',
	periodCardTotalReward: 'Kabuuang reward',
	...
	periodCardStatRemain: 'Natitira',
	periodCardClaimNow: 'I-claim ngayon',
	periodCardNextIn: 'Susunod na claim sa loob ng',
	periodCardSwipeHint: 'Mag-swipe para makita ang lahat ng {n} araw',
	periodCardExpired: 'Nag-expire na',
	periodCardBuyDone: 'Matagumpay ang pagbili!',
	periodCardDoneAmount: 'I-claim ang instant cashback na {amount} sa card',
	periodCardDoneDaily: 'Magsisimula bukas ang pang-araw-araw na reward sa loob ng {n} araw — bumalik araw-araw',
	periodCardKnow: 'Nakuha ko',
	periodCardTookRealtime: 'Na-credit na ang instant cashback',
	periodCardTookDaily: 'Na-credit na ang pang-araw-araw na reward',
	periodCardSoldOutTitle: 'Ubos na ngayong araw',
	periodCardSoldOut: 'Ubos na',
	periodCardGateTitle: 'Hindi pa kwalipikado',
	periodCardGateDesc: 'Kailangan ng mas mataas na kabuuang deposito. Kailangan mo pa ng {gap} para makasali',
	periodCardBalanceDesc: 'Ang card na ito ay nangangailangan ng {need} na cash balance',
	periodCardGoRecharge: 'Mag-recharge ngayon',
	periodCardWeekName: 'Weekly Card',
	periodCardMonthName: 'Monthly Card',
	damanRule: 'Ang platform ng {0} ay nagtataguyod ng pagiging patas, katarungan, at pagiging bukas. Pangunahing nagpapatakbo kami ng patas na lottery, mga larong blockchain, mga live na casino, at mga laro ng slot machine.',
	damanRule2: 'Nagtatrabaho si {0} sa higit sa 10,000 online na live na dealer ng laro at mga laro ng slot, na lahat ay na-verify na patas na laro.',
	damanRule3: 'Sinusuportahan ni {0} ang mabilis na deposito at pag-withdraw, at inaasahan ang iyong pagbisita.',
	damanWarn: 'Maaaring nakakahumaling ang pagsusugal, mangyaring maglaro nang makatwiran.',
	damanWarn2: 'Tumatanggap lang si {0} ng mga customer na higit sa 18 taong gulang.',
	code1051: 'Mali ang format ng USDT wallet address',
	code1031: 'Hindi natugunan ang kinakailangang deposito',
	code1032: 'Ubos na ang tier na ito ngayong araw',
}
