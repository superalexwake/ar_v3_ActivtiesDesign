export default {
	exclusiveCouponsClaim: 'Эксклюзивные купоны ({0})· Получить при регистрации',
	couponNoThreshold: 'Без минимума',
	couponThreshold: 'От {0}',
	couponValidDays: '{0} дн.',
	couponUpperLimit: 'До {0}',
	couponRechargeName: 'Купон на пополнение',
	...
	couponArrivalTitle: 'Эксклюзивные купоны на пополнение',
	couponArrivalSubtitle: 'Оператор дарит вам {0} купонов на пополнение',
	couponMaxReturns: 'Возврат за пополнение {0}%',
	couponClaimNow: 'Получить ({0})',
	myRechargeCoupon: 'Мои купоны на пополнение',
	couponUnused: 'Неиспользованные',
	couponUsed: 'Использованные',
	couponExpired: 'Истёкшие',
	couponGoUse: 'Использовать',
	...
	shareToOtherApps: 'Поделитесь в других приложениях, чтобы пригласить друга',
	urgeOrder: 'Ускорить заказ',
	urgeOrderSuccess: 'Ваш запрос отправлен ответственному специалисту. Мы обработаем вашу проблему как можно скорее. Пожалуйста, ожидайте с терпением. Спасибо за ваше понимание и поддержку',
	...
	firstBindNameLockTip:
		'Это ваш первый счёт для получения средств. После сохранения имя будет заблокировано, и все последующие способы вывода должны использовать это же имя.',
	...
	code1047: 'Этот купон доступен только участникам, которые ещё не пополняли счёт',
	...
	getMoney: 'Получить {0}',
	downAppRechargeReward: 'Пополните {0}, получите {1}',
	eventRewardsLoginTitle: 'Награды события',
	eventRewardsLoginDescriptionPrefix: 'Войдите, чтобы участвовать в ',
	eventRewardsLoginDescriptionHighlight: 'наградах события',
	eventRewardsLoginDescriptionSuffix: ' и открыть все 8 эксклюзивных наград',
	eventRewardsLoginPrimary: 'Войти и участвовать',
	eventRewardsLoginSecondary: 'Пока не входить, продолжить просмотр',
	charAtone: 'Первая цифра должна быть 0',
	viewWorkOrderProgress: 'Посмотреть статус заявки', // 充值记录-查看工单进度
	actualCredit: 'Вы получаете',
	...
	bonus: 'Бонус',
	notifyClaim: 'Получить',
	notifyLater: 'Позже',
	notifyReconnectNow: 'Переподключиться сейчас',
	notifyImportantNotice: 'Важное уведомление',
	notifyImportantNoticeMessage: 'Выбранный вами банк {bankCode} может требовать двухфакторную аутентификацию. Пожалуйста, оставайтесь онлайн на платформе в течение 15–30 минут после отправки запроса.',
	notifyImportantNoticeSecondary: 'Если вы пропустите две попытки проверки, этот вывод средств может не удаться.',
	notifyCancel: 'Отмена',
	notifySubmit: 'Отправить',
	notifyViewWallet: 'Открыть кошелёк',
	notifyWithdrawAgain: 'Вывести снова',
	notifyCountdown: 'Обратный отсчёт: {time}',
	kycCountdownVerifyTitle: 'Завершите проверку до окончания обратного отсчёта, иначе этот вывод средств не удастся!',
	notifyStayingMinutes: 'Оставайтесь не менее 15 минут',
	notifyWithdrawReturnedTip: 'Пожалуйста, повторно отправьте запрос на вывод средств. Рекомендуем оставаться в приложении 15–30 минут после отправки.',
	notifyCenterTitle: 'Центр уведомлений({n})',
	notifyExpand: 'Развернуть',
	notifyCollapse: 'Свернуть',
	notifyJustNow: 'Сейчас',
	notifyMinutesAgo: '{n} мин. назад',
	notifyHoursAgo: '{n} ч. назад',
	notifyDaysAgo: '{n} дн. назад',
	orderAmountLabel: 'Order amount',
	betMulti: 'Мульт',
	code1051: 'Неверный формат адреса USDT-кошелька',
	periodCardWeekTab: 'Недельная карта',
	periodCardMonthTab: 'Месячная карта',
	periodCardPick: 'Выберите уровень · Купить сейчас',
	periodCardInstant: 'Мгновенный кэшбэк',
	periodCardDaily: 'Ежедневно',
	periodCardBuy: 'Купить сейчас',
	periodCardOrigin: 'Обычная цена',
	periodCardNoTier: 'В этой категории нет доступных уровней',
	periodCardBuyWeekTitle: 'Купить недельную карту',
	periodCardBuyMonthTitle: 'Купить месячную карту',
	periodCardConfirmInstant: 'Вы получите мгновенный кэшбэк',
	periodCardConfirmDaily: 'Вы получаете ежедневно',
	periodCardTotalReward: 'Общая награда',
	...
	periodCardStatRemain: 'Осталось',
	periodCardClaimNow: 'Получить сейчас',
	periodCardNextIn: 'Следующее получение через',
	periodCardSwipeHint: 'Пролистайте, чтобы увидеть все {n} дней',
	periodCardExpired: 'Истекло',
	periodCardBuyDone: 'Покупка успешна!',
	periodCardDoneAmount: 'Получите мгновенный кэшбэк {amount} на карточке',
	periodCardDoneDaily: 'Ежедневные награды начнутся завтра и продлятся {n} дней — заходите каждый день',
	periodCardKnow: 'Понятно',
	periodCardTookRealtime: 'Мгновенный кэшбэк зачислен',
	periodCardTookDaily: 'Ежедневная награда зачислена',
	periodCardSoldOutTitle: 'Сегодня распродано',
	periodCardSoldOut: 'Распродано',
	periodCardGateTitle: 'Пока не соответствует условиям',
	periodCardGateDesc: 'Требуется большая сумма пополнений. Вам не хватает {gap} для участия',
	periodCardBalanceDesc: 'Для этой карты нужен денежный баланс {need}',
	periodCardGoRecharge: 'Пополнить сейчас',
	periodCardWeekName: 'Недельная карта',
	periodCardMonthName: 'Месячная карта',
	code1031: 'Условие пополнения не выполнено',
	code1032: 'Этот уровень сегодня распродан',
}