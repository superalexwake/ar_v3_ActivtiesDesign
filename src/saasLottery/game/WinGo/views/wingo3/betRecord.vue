<template>
	<div class="wingo-record">
		<NavBar left-arrow class="main" title="Win Go" @click-left="back" />
		<!-- 时段 tab -->
...
import BetRecordList from '@/saasLottery/game/WinGo/components/wingo3/betRecordList.vue'

const router = useRouter()
const { gameList, getGameList } = useGlobal()

// 本游戏类型前缀（用于从后端 gameList 里筛出本游戏的时段）
const GAME_PREFIX = 'WinGo'
