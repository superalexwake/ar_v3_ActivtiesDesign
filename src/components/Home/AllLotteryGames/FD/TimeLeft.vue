			...
			<div class="box">
				<div v-for="(item, index) in resultNew" :key="index" class="slot-column">
					<div :class="['slot-transform', 'transform' + index, top1 == 1 && 'slot-scroll']">
						<div class="slot-num" v-for="(num1, index2) in item.arr" :num="item" :key="'2' + index2">{{ num1 }}</div>
