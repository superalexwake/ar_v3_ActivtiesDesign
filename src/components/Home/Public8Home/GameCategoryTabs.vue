...
import iconHomeTabBg from '@icon/home/tabBg.png'
import iconHomeTabBgActive from '@icon/home/tabBgActive.png'
...
// 背景图（用 v-bind 传到 CSS）
const tabBg = `url(${iconHomeTabBg})`
const tabBgActive = `url(${iconHomeTabBgActive})`
