...
// const HotGames = defineAsyncComponent(() => import('@/svg/home/gameRec.vue'))
		...
		.list {
			...
			.win-odds{
				...
				span{
					...
					flex: 1;
					line-height: 40px;
					color: var(--darkTextW, var(--text_color_L4));
					&:first-child{
						padding-left: 10px;
					}
					&:last-child{
