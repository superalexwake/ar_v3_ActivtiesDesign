...
import BigaWard from "@/components/Home/WhiteGoldHome/GameList/bigaward.vue";
...
const getGameList = async () => {
	...
	if (res) {
		...
		bigWardList.value = gamelist?.awardRecordList|| []
