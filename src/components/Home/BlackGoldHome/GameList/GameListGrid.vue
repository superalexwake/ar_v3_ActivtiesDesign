<template>
	<div class="gameListGrid__container" :class="{ all_container: isAll }">
		<!-- 热门 -->
		<HotGameItem v-if="getType === 1" :gameList="currentGame.gameList" @onItemClick="onItemClick" :isAll="isAll" />
		<!-- 体育、棋牌、真人 -->
		...
		<!-- 小游戏、捕鱼 -->
		<OnlineGamesItem v-if="getType === 5" :gameType="currentGame.gameType" :gameData="currentGame" :isAll="isAll" @onItemClick="onItemClick" />
