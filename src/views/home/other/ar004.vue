...
import GamesList from '@/components/Home/ar004Home/AllGames/GameList.vue'
...
import GameMenu from '@/components/Home/ar004Home/GameMenu/index.vue'
...
.bluehome {
	...
	.swiper_box {
		// 与 NavBar 间距 16px；用 padding 避免与相邻元素外边距合并
		padding: 16px 0 0;
	}
}
</style>
