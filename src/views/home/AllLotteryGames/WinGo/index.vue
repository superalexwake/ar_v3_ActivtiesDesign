<template>
	<div class="WinGo__C">
		...
		<!-- 游戏开始时间倒计时 -->
		<TimeLeft :currentInfo="currentInfo" :winNum="winNum" :gameName="currentGame.typeName" :currentGame="currentGame" />
		<!-- 投注表 -->
		<Betting
        ...
        class="game-record"
				...
				:listApi="winGoGetNoaverageEmerdList"
...
// 最近中奖号码
const winNum = ref<number[]>([0, 0, 0, 0, 0])
// 是否展示长龙
