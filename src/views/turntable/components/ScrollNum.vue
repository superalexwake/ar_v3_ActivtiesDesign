<template>
  <span class="scroll_num">{{ displayValue }}</span>
</template>

<script setup lang="ts">
import { ref, computed, watch, onMounted, onBeforeUnmount } from 'vue'
import {useAnimationFrameUtils} from './useScrollNum'

const { requestAnimationFrame, cancelAnimationFrame } = useAnimationFrameUtils()
